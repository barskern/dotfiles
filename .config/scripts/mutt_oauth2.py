...
TH_CLIENT_ID = "08162f7c-0fd2-4200-a84a-f25a4db0b584"
TH_CLIENT_SECRET = "TxRBilcHdC6WGBee]fs?QR:SJ8nI[g82"
...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'post@barskern.no']
